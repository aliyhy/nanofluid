...
namespace Foam
{
    ...
    makeChemistrySolverTypes(psiReactionThermo, nanoFluidThermoPhysics); //added
    makeChemistrySolverTypes(psiReactionThermo, CorcioneCorcioneNanoFluidThermoPhysics); //added
    makeChemistrySolverTypes(psiReactionThermo, CorcioneCocciaNanoFluidThermoPhysics); //added
    makeChemistrySolverTypes(psiReactionThermo, CorcioneTimofeevaNanoFluidThermoPhysics); //added
    ...
    makeChemistrySolverTypes(rhoReactionThermo, nanoFluidThermoPhysics); //added
    makeChemistrySolverTypes(rhoReactionThermo, CorcioneCorcioneNanoFluidThermoPhysics); //added
    makeChemistrySolverTypes(rhoReactionThermo, CorcioneCocciaNanoFluidThermoPhysics); //added
    makeChemistrySolverTypes(rhoReactionThermo, CorcioneTimofeevaNanoFluidThermoPhysics); //added
