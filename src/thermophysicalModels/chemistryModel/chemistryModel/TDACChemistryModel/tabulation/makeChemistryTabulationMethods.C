...
namespace Foam
{
    ...
    makeChemistryTabulationMethods(psiReactionThermo, nanoFluidThermoPhysics);  //added
    makeChemistryTabulationMethods(psiReactionThermo, CorcioneCorcioneNanoFluidThermoPhysics);  //added
    makeChemistryTabulationMethods(psiReactionThermo, CorcioneTimofeevaNanoFluidThermoPhysics);  //added
    makeChemistryTabulationMethods(psiReactionThermo, CorcioneCocciaNanoFluidThermoPhysics);  //added
    ...
    makeChemistryTabulationMethods(rhoReactionThermo, nanoFluidThermoPhysics);   //added
    makeChemistryTabulationMethods(rhoReactionThermo, CorcioneCorcioneNanoFluidThermoPhysics);   //added
    makeChemistryTabulationMethods(rhoReactionThermo, CorcioneCocciaNanoFluidThermoPhysics);   //added
    makeChemistryTabulationMethods(rhoReactionThermo, CorcioneTimofeevaNanoFluidThermoPhysics);   //added
