...
namespace Foam
{
    ...
    makeChemistryReductionMethods(psiReactionThermo, nanoFluidThermoPhysics);  //added
    makeChemistryReductionMethods(psiReactionThermo, CorcioneCorcioneNanoFluidThermoPhysics);  //added
    makeChemistryReductionMethods(psiReactionThermo, CorcioneCocciaNanoFluidThermoPhysics);  //added
    makeChemistryReductionMethods(psiReactionThermo, CorcioneTimofeevaNanoFluidThermoPhysics);  //added
    ...
    makeChemistryReductionMethods(rhoReactionThermo, nanoFluidThermoPhysics); //added
    makeChemistryReductionMethods(rhoReactionThermo, CorcioneCorcioneNanoFluidThermoPhysics); //added
    makeChemistryReductionMethods(rhoReactionThermo, CorcioneCocciaNanoFluidThermoPhysics); //added
    makeChemistryReductionMethods(rhoReactionThermo, CorcioneTimofeevaNanoFluidThermoPhysics); //added
