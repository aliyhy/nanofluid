...
)
{
  const fvMesh& mesh = this->T_.mesh();
    ...
    {
        heCells[celli] =
            this->cellMixture(celli).HE(mesh, pCells[celli], TCells[celli]);
    }
...
//  const fvMesh& mesh = this->T_.mesh();
    ...
    forAll(heBf, patchi)
    {
        ...
        {
            hep[facei] =
                this->patchFaceMixture(patchi, facei).HE(mesh, pp[facei], Tp[facei]);
        }
    }
...
) const
{
  //  const fvMesh& mesh = this->T_.mesh();
    ...
    forAll(T, celli)
    {
        he[celli] = this->cellMixture(cells[celli]).HE(mesh, p[celli], T[celli]);
    }
...
{  //const fvMesh& mesh = this->T_.mesh();
    ...
    {
        he[facei] =
            this->patchFaceMixture(patchi, facei).HE(mesh, p[facei], T[facei]);
    }
...
) const
{
    ...
    {
        cp[facei] =
            this->patchFaceMixture(patchi, facei).Cp(mesh,  p[facei], T[facei]);
    }
...
Foam::heThermo<BasicThermo, MixtureType>::Cp() const
{
    ...
    {
        cp[celli] =
            this->cellMixture(celli).Cp(mesh, this->p_[celli], this->T_[celli]);
    }
    ...
    forAll(cpBf, patchi)
    {
        ...
        {
            pCp[facei] =
                this->patchFaceMixture(patchi, facei).Cp(mesh, pp[facei], pT[facei]);
        }
    }
...
) const
{
    ...
    {
        cv[facei] =
            this->patchFaceMixture(patchi, facei).Cv(mesh, p[facei], T[facei]);
    }
...
Foam::heThermo<BasicThermo, MixtureType>::Cv() const
{
    ...
    {
        cv[celli] =
            this->cellMixture(celli).Cv(mesh, this->p_[celli], this->T_[celli]);
    }
...
) const
{
    ...
    {
        gamma[facei] =
            this->patchFaceMixture(patchi, facei).gamma(mesh, p[facei], T[facei]);
    }
...
Foam::heThermo<BasicThermo, MixtureType>::gamma() const
{
    ...
    {
        gamma[celli] =
            this->cellMixture(celli).gamma(mesh, this->p_[celli], this->T_[celli]);
    }
...
) const
{
    ...
    {
        Cpv[facei] =
            this->patchFaceMixture(patchi, facei).Cpv(mesh, p[facei], T[facei]);
    }
...
Foam::heThermo<BasicThermo, MixtureType>::Cpv() const
{
    ...
    {
        Cpv[celli] =
            this->cellMixture(celli).Cpv(mesh, this->p_[celli], this->T_[celli]);
    }
    ...
    forAll(CpvBf, patchi)
    {
        ...
        {
            pCpv[facei] =
                this->patchFaceMixture(patchi, facei).Cpv(mesh, pp[facei], pT[facei]);
        }
    }
...
) const
{
    ...
    {
        CpByCpv[facei] =
            this->patchFaceMixture(patchi, facei).CpByCpv(mesh, p[facei], T[facei]);
    }
...
) const
{
    ...
    {
        T[celli] =
            this->cellMixture(cells[celli]).THE(h[celli], mesh, p[celli], T0[celli]);
    }
...
) const
{
    ...
    forAll(h, facei)
    {
        ...
        (
            patchi,
            facei
        ).THE(h[facei], mesh, p[facei], T0[facei]);
    }
