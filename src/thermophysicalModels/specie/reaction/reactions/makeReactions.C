...
namespace Foam
{
    ...
    makeReactions(nanoFluidThermoPhysics, nanoFluidReaction)  //added
    makeReactions(CorcioneCorcioneNanoFluidThermoPhysics, CorcioneCorcioneNanoFluidReaction)  //added
    makeReactions(CorcioneCocciaNanoFluidThermoPhysics, CorcioneCocciaNanoFluidReaction)  //added
    makeReactions(CorcioneTimofeevaNanoFluidThermoPhysics, CorcioneTimofeevaNanoFluidReaction)  //added
