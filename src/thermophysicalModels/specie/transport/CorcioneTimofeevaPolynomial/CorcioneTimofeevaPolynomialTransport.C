...
Foam::CorcioneTimofeevaPolynomialTransport<Thermo, PolySize>::CorcioneTimofeevaPolynomialTransport
(
...
template<class Thermo, int PolySize>
void Foam::CorcioneTimofeevaPolynomialTransport<Thermo, PolySize>::write(Ostream& os) const
{
...
(
    Ostream& os,
    const CorcioneTimofeevaPolynomialTransport<Thermo, PolySize>& pt
)
{
    pt.write(os);
    return os;
