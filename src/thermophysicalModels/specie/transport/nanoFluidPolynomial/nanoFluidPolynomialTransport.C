...
Foam::nanoFluidPolynomialTransport<Thermo, PolySize>::nanoFluidPolynomialTransport
(
...
:
    ...
    nP_(dict.subDict("nanoParticle").get<scalar>("nP"))
{}
...
template<class Thermo, int PolySize>
void Foam::nanoFluidPolynomialTransport<Thermo, PolySize>::write(Ostream& os) const
{
