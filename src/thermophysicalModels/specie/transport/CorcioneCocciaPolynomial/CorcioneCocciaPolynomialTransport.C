...
Foam::CorcioneCocciaPolynomialTransport<Thermo, PolySize>::CorcioneCocciaPolynomialTransport
(
...
:
    ...
    Tc_(dict.subDict("transport").get<scalar>("Tc")),
...
template<class Thermo, int PolySize>
void Foam::CorcioneCocciaPolynomialTransport<Thermo, PolySize>::write(Ostream& os) const
{
