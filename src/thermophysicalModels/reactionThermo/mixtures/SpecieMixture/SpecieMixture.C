...
{
    return this->getLocalThermo(speciei).Cp(mesh, p, T);
}
...
{
    return this->getLocalThermo(speciei).Cv(mesh, p, T);
}
...
{
    return this->getLocalThermo(speciei).HE(mesh, p, T);
}
...
{
    return this->getLocalThermo(speciei).Ha(mesh, p, T);
}
...
{
    return this->getLocalThermo(speciei).Hs(mesh, p, T);
}
...
{
    return this->getLocalThermo(speciei).S(mesh, p, T);
}
...
{
    return this->getLocalThermo(speciei).Es(mesh, p, T);
}
...
{
    return this->getLocalThermo(speciei).G(mesh, p, T);
}
...
{
    return this->getLocalThermo(speciei).A(mesh, p, T);
}
...
{
    return this->getLocalThermo(speciei).mu(mesh, p, T);
}
...
{
    return this->getLocalThermo(speciei).kappa(mesh, p, T);
}
...
{
    return this->getLocalThermo(speciei).alphah(mesh, p, T);
}
...
{
    return this->getLocalThermo(speciei).rho(mesh, p, T);
}
