...
makeThermoPhysicsReactionThermos      //added
(
    rhoThermo,
    rhoReactionThermo,
    heRhoThermo,
    multiComponentMixture,
    nanoFluidThermoPhysics
);
...
(
    ...
    heRhoThermo,
    multiComponentMixture,
    CorcioneCorcioneNanoFluidThermoPhysics
);
...
(
    ...
    heRhoThermo,
    multiComponentMixture,
    CorcioneCocciaNanoFluidThermoPhysics
);
...
(
    ...
    heRhoThermo,
    multiComponentMixture,
    CorcioneTimofeevaNanoFluidThermoPhysics
);
...
makeThermoPhysicsReactionThermo  //added
(
    rhoReactionThermo,
    heRhoThermo,
    singleComponentMixture,
