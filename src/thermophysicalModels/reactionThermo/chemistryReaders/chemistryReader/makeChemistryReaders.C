...
makeChemistryReader(CorcioneCorcioneNanoFluidThermoPhysics);  //added
makeChemistryReader(CorcioneCocciaNanoFluidThermoPhysics);  //added
makeChemistryReader(CorcioneTimofeevaNanoFluidThermoPhysics);  //added

makeChemistryReader(nanoFluidThermoPhysics);  //added
...
makeChemistryReaderType(foamChemistryReader, nanoFluidThermoPhysics); //added
makeChemistryReaderType(foamChemistryReader, CorcioneCorcioneNanoFluidThermoPhysics); //added
makeChemistryReaderType(foamChemistryReader, CorcioneCocciaNanoFluidThermoPhysics); //added
makeChemistryReaderType(foamChemistryReader, CorcioneTimofeevaNanoFluidThermoPhysics); //added
